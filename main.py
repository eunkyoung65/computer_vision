...
windows2_form = uic.loadUiType("windows2.ui")[0]


class MainWindow(QMainWindow, windows2_form):
    ...
    def plus_image(self):
        ...
        self.pluslabel_2.setPixmap(pixmap)
    ...
    def saveimage(self) :
        ...
        self.qPixmapSaveVar = self.label2.pixmap()
